...
check_fullscreen_mode = (By.CSS_SELECTOR, 'button[aria-label="Fullscreen (f)"]')
...
pause_message = (By.CSS_SELECTOR, 'button[aria-label="Pause (space/k)"]')
start_watching = (By.CSS_SELECTOR, 'button[data-a-target="player-overlay-mature-accept"]')
mute_button = (By.CSS_SELECTOR, 'button[aria-label="Mute (m)"]')
...
select_report = (
    By.CSS_SELECTOR, 'select[class="ScInputBase-sc-vu7u7d-0 ScSelect-sc-gz38t2-0'
                     ' gXVFsI AJDRH InjectLayout-sc-1i43xsx-0 bLZRbT tw-select"]', '«Audio and video stutter')
...
close_chat_button = (By.CSS_SELECTOR, 'button[aria-label="Collapse Chat"]')
...
subscribe_main_button = (By.CSS_SELECTOR, 'button[aria-label="Subscribe $4.99"]')
...
show_love_gif = (By.CSS_SELECTOR, 'div[aria-label="showlove overlay"]')
party_button = (By.CSS_SELECTOR, 'img[alt="party"]')
party_gif = (By.CSS_SELECTOR, 'div[aria-label="party overlay"]')
lul_button = (By.CSS_SELECTOR, 'img[alt="lul"]')
lul_gif = (By.CSS_SELECTOR, 'div[aria-label="lul overlay"]')
biblethump_button = (By.CSS_SELECTOR, 'img[alt="biblethump"]')
biblethump_gif = (By.CSS_SELECTOR, 'div[aria-label="biblethump overlay"]')
...
report_translation_button = (By.CSS_SELECTOR, 'button[aria-label="Report Live Stream"]')
report_other_button = (By.CSS_SELECTOR, 'button[aria-label="Report Something Else"]')
searching_field = (By.CSS_SELECTOR, 'input[aria-label="Search Input"]')
