...
check_fullscreen_mode = (By.CSS_SELECTOR, 'button[data-a-target="player-fullscreen-button"]')
...
pause_message = (By.CSS_SELECTOR, 'button[data-a-player-state="paused"]')
start_watching = (By.CSS_SELECTOR, 'button[data-a-target="player-overlay-mature-accept"]')
mute_button = (By.CSS_SELECTOR, 'button[data-a-target="player-mute-unmute-button"]')
...
select_report = (By.CSS_SELECTOR, 'select[class="ScInputBase-sc-vu7u7d-0 ScSelect-sc-gz38t2-0 gXVFsI AJDRH '
                                  'InjectLayout-sc-1i43xsx-0 bLZRbT tw-select"]')
...
open_chat_button = (By.CSS_SELECTOR, 'button[aria-label="Expand Chat"]')
close_chat_button = (By.CSS_SELECTOR, 'button[data-a-target="right-column__toggle-collapse-btn"]')
...
join_to_twitch_window = (By.CSS_SELECTOR, 'div[class="Layout-sc-1xcs6mc-0 jOZnjb auth-modal__left-content"]')
...
subscribe_main_button = (By.CSS_SELECTOR, 'button[data-a-target="subscribe-button-tier-1000"]')
...
show_love_gif = (By.CSS_SELECTOR, 'div[class="Layout-sc-1xcs6mc-0 iZLKjx gift-theme-overlay"]')
party_button = (By.CSS_SELECTOR, 'img[alt="party"]')
party_gif = (By.CSS_SELECTOR, 'div[class="Layout-sc-1xcs6mc-0 iZLKjx gift-theme-overlay"]')
lul_button = (By.CSS_SELECTOR, 'img[alt="lul"]')
lul_gif = (By.CSS_SELECTOR, 'div[class="Layout-sc-1xcs6mc-0 byWBVQ gift-theme-overlay"]')
biblethump_button = (By.CSS_SELECTOR, 'img[alt="biblethump"]')
biblethump_gif = (By.CSS_SELECTOR, 'div[class="Layout-sc-1xcs6mc-0 iZLKjx gift-theme-overlay"]')
...
report_translation_button = (By.CSS_SELECTOR, 'button[data-a-target="report-button-report-button"]')
report_other_button = (By.CSS_SELECTOR, 'button[data-a-target="report-button-report-button"]')
searching_field = (By.CSS_SELECTOR, 'input[data-a-target="tw-input"]')
zubarefff_channel = (By.CSS_SELECTOR, 'a[href="/zubarefff"]')
...
login_button = (By.CSS_SELECTOR, 'button[data-test-selector="user-menu__logout-button"]')
